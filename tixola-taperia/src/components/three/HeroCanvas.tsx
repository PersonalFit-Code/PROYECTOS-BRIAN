 ...
 * reduced-motion); mientras carga, y en el resto de casos, muestra el fallback estático.
 * El fallback se funde al negro-hierro cuando la escena pinta su primer frame.
 */
